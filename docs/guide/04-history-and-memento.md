...
| `HistoryEvent` (sealed) | [history_event.dart:6](../../lib/engine/history/history_event.dart) | Nine event subclasses: `ExecuteEdit`, `AppendEdit`, `UndoEdit`, `RedoEdit`, `ToggleOpEnabled`, `JumpToEntry`, `SetAllOpsEnabled`, `ClearHistory`, `ApplyPipelineEvent`. |

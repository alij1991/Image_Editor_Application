...
| D4 | Move heavy *Dart* encodes off the UI isolate (editor export `encodeJpg/Png`, all 4 scanner exporters) — ANR/jank risk on 4K/multi-page. (Collage uses engine-side `toByteData`, handled under D3.) |
